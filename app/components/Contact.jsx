...
const Contact = (isDarkMode) => {
  ...
  return (
    ...
    id='contact'  className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-center bg-[length:90%_auto]
    dark:bg-none'>
      <motion.h4 
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        transition={{delay:1.1, duration:0.6}}
         type="text" placeholder='Enter you name' required
        ...
        type="email" placeholder='Enter you email' required
