  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      transition={{delay:0.7, duration:0.5}}className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        Welcome to my web development portfolio. Explore a collection of projects showcasing my expertise in full-stack development with 10 years of experience in multiple companies like Microsoft, Tesla, and Apple.
      </motion.p>
